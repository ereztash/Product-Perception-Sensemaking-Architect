...
ahead of it. Five research branches and one trace branch have been pushed since, so the live
count is twenty.
...
The twenty-three branches ahead of `main`. None of them may be deleted by this command; every
