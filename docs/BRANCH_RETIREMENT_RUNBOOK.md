...
ahead of it. Five research branches have been pushed since, so the live count is nineteen.
...
The eighteen branches ahead of `main`. None of them may be deleted by this command; every
