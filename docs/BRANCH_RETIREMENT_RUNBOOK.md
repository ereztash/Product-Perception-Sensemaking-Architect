...
ahead of it. Eleven branches have been pushed since, so the live count is twenty-five.
...
The twenty-four branches ahead of `main`. None of them may be deleted by this command; every
