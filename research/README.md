...
- **G — Generalization (1–7)**
- **C — Cultural breadth (0–4)**
...
- empirical HCI / cognitive / behavioral research;
- interaction/design research;
- accessibility/human-factors standards where relevant;
- cross-cultural/localization/socio-cultural research;
- adjacent disciplines operationalizing the mechanism differently;
- strong-provenance field incidents;
- falsification/null-result sources.

Shared dataset/lab/review lineage counts as one evidence family where appropriate.
